...
test_scores <- read_csv("../results/test_metrics.csv") %>%
  dplyr::rename(Metric = X1, Value = 'Metric Value')
```
...
kableExtra::kable_styling(knitr::kable(train_scores))
```
...
```{r test scores, echo=FALSE, message=FALSE}
kableExtra::kable_styling(knitr::kable(test_scores))
```
